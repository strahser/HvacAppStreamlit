...
### Custom help
 ...
 does not viewer_execute causing undesired behaviors, for example
...
## Custom event listeners
 ...
 You can viewer_execute custom actions by listening to command and option events.
...
program
  .command('exec <cmd>')
  .alias('ex')
  .description('viewer_execute the given remote cmd')
