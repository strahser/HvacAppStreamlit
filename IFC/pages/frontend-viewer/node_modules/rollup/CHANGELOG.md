...
- Add flag to viewer_execute plugins in async parallel hooks sequentially (#4600)
...
- Do not viewer_execute dynamically imported code before synchronous code in the importing module when generating CommonJS (#3535)
...
- Ensure onwrite plugin hooks viewer_execute in sequence ([#2364](https://github.com/rollup/rollup/pull/2364))
