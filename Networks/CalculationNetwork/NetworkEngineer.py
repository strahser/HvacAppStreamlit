...
class ExcelQuery:
    def __init__(self, system_type: str, input_settings_df: pd) -> None:
        ...
        self.input_settings_df: pd.DataFrame = input_settings_df
...
class DropPressure:
    ...
    def __get_lamda_altshul(
        ...
        lamda = (
            0.11 * (self.ke / self.diameter + 68 / self.Re) ** 0.25
            if self.diameter
            else 0
        )
        return lamda
    ...
    def __str__(self) -> str:
        ...
        dynamyc pressure unit = {self.get_presure_dynamic_drop()}
        """
...
class SettingBuilder:
    ...
    def __init__(
        self, excel_loader: ExcelLoader, power: float, network_branch_type: str
    ) -> None:
