...
class PolygonPlotlyControl:
    def __init__(self,
        ...
        self._df = self._get_polygon_merge_list(_df, _df[plot_view.level_column_name].unique()[0])
    ...
    def _get_polygon_merge_list(self, _df: pd.DataFrame, level_val: str):
        polygon_merge = PolygonMerge(
            in_df=_df,
            json_path=self.upload_layout.json_file,
