...
from PrincipalSchems.Dxf.DxfConstants import PLOTLY_COLORS, TEXT_PROPERTY, TEXT_EQUIPMENT_OFFSET_Y
...
class DxfDrawEquipmentData:
    ...
    def __add_equipment_marker(self, marker_coordinates: [tuple[float, float]], system_text, block_symbol,scale = 2):
        ...
        self.msp.add_text(system_text, dxfattribs=TEXT_PROPERTY) \
            .set_placement((marker_coordinates[0],
                            marker_coordinates[1] + 5*scale+TEXT_EQUIPMENT_OFFSET_Y),
