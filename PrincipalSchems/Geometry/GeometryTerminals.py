...
import PrincipalSchems.Geometry.GeometryLines as gl
...
class CreateCurvesFromStartPoint():
...
class CreateCurvesFilters:
	def __init__(self,
        ...
        Args:
            ...
            device_location_option (list): 'up', 'down', 'left', 'right',
	...
	def _choose_long_short_curve_filter(self):
		option_1: gl.Line = self.curve_dictionary[self.device_orienation_option1]
		option_2: gl.Line = self.curve_dictionary[self.device_orienation_option2]
		main_condition = option_1.Length >= option_2.Length
		if main_condition:
			self.long_curve = option_1
			self.short_curve = option_2
		else:
			self.long_curve = option_2
			self.short_curve = option_1
