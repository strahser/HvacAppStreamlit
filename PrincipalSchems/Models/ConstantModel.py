...
class SystemProperty:
    ...
    def level_distance(self):
        if self.x_end_points and self.y_end_points and self.offset_point_x and self.offset_point_y:
            return math.sqrt((self.offset_point_x - self.x_end_points) ** 2 + (self.offset_point_y - self.y_end_points) ** 2)
