...
class SqlCRUDOperationControl:
	...
	def update_input_date(self, table_add_data_view: TableAddDataView):
		if table_add_data_view.update_input_date:
			self.sql_query.df_read_sql()

	def create_column(self, table_add_data_view: TableAddDataView):
	...
	def add_data_to_column(self, filtered_df: list, table_add_data_view: TableAddDataView):
	...
	def drop_column(self, table_add_data_view: TableAddDataView):
